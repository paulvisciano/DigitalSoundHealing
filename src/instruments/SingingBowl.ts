...
import { InstrumentGestureEnum, InstumentInterface, InstumentName } from "./InstrumentInterface";
...
export class SingingBowl implements InstumentInterface {
    ...
    getSoundPath = (note: NoteEnum, method: InstrumentGestureEnum) => {
        let soundPath;

        switch (note) {
            case NoteEnum.A:
                soundPath = method === InstrumentGestureEnum.Strike ? bowlAStrike : bowlAGlide;
                break;
            case NoteEnum.B:
                soundPath = method === InstrumentGestureEnum.Strike ? bowlBStrike : bowlBGlide;
                break;
            case NoteEnum.C:
                soundPath = method === InstrumentGestureEnum.Strike ? bowlCStrike : bowlCGlide;
                break;
            case NoteEnum.D:
                soundPath = method === InstrumentGestureEnum.Strike ? bowlDStrike : bowlDGlide;
                break;
            case NoteEnum.E:
                soundPath = method === InstrumentGestureEnum.Strike ? bowlEStrike : bowlEGlide;
                break;
            case NoteEnum.F:
                soundPath = method === InstrumentGestureEnum.Strike ? bowlFStrike : bowlFGlide;
                break;
            case NoteEnum.G:
                soundPath = method === InstrumentGestureEnum.Strike ? bowlGStrike : bowlGGlide;
                break;
            default:
                soundPath = null;
                break;
